...
#include "image_transport_tutorials/msg/rosidl_typesupport_c__visibility_control.h"
...
static const _ResizedImage_type_support_symbol_names_t _ResizedImage_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, image_transport_tutorials, msg, ResizedImage)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, image_transport_tutorials, msg, ResizedImage)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_image_transport_tutorials
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, image_transport_tutorials, msg, ResizedImage)() {
  return &::image_transport_tutorials::msg::rosidl_typesupport_c::ResizedImage_message_type_support_handle;
}
