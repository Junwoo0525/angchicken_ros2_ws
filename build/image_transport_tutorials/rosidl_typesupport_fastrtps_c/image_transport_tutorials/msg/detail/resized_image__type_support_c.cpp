...
#include "image_transport_tutorials/msg/detail/resized_image__rosidl_typesupport_fastrtps_c.h"
...
#include "image_transport_tutorials/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_image_transport_tutorials
...
using _ResizedImage__ros_msg_type = image_transport_tutorials__msg__ResizedImage;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_image_transport_tutorials
size_t get_serialized_size_image_transport_tutorials__msg__ResizedImage(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ResizedImage__ros_msg_type * ros_message = static_cast<const _ResizedImage__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _ResizedImage__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_image_transport_tutorials__msg__ResizedImage(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_image_transport_tutorials
size_t max_serialized_size_image_transport_tutorials__msg__ResizedImage(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_image_transport_tutorials__msg__ResizedImage(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, image_transport_tutorials, msg, ResizedImage)() {
