...
#include <stddef.h>
#include "image_transport_tutorials/msg/detail/resized_image__rosidl_typesupport_introspection_c.h"
#include "image_transport_tutorials/msg/rosidl_typesupport_introspection_c__visibility_control.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  image_transport_tutorials__msg__ResizedImage__init(message_memory);
}

void ResizedImage__rosidl_typesupport_introspection_c__ResizedImage_fini_function(void * message_memory)
{
  image_transport_tutorials__msg__ResizedImage__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember ResizedImage__rosidl_typesupport_introspection_c__ResizedImage_message_member_array[3] = {
  {
    ...
    offsetof(image_transport_tutorials__msg__ResizedImage, original_height),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(image_transport_tutorials__msg__ResizedImage, original_width),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(image_transport_tutorials__msg__ResizedImage, image),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers ResizedImage__rosidl_typesupport_introspection_c__ResizedImage_message_members = {
  "image_transport_tutorials__msg",  // message namespace
  "ResizedImage",  // message name
  3,  // number of fields
  sizeof(image_transport_tutorials__msg__ResizedImage),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_image_transport_tutorials
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, image_transport_tutorials, msg, ResizedImage)() {
