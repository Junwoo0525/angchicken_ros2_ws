...
{
  new (message_memory) image_transport_tutorials::msg::ResizedImage(_init);
}

void ResizedImage_fini_function(void * message_memory)
{
  auto typed_message = static_cast<image_transport_tutorials::msg::ResizedImage *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ResizedImage_message_member_array[3] = {
  {
    ...
    offsetof(image_transport_tutorials::msg::ResizedImage, original_height),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(image_transport_tutorials::msg::ResizedImage, original_width),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(image_transport_tutorials::msg::ResizedImage, image),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ResizedImage_message_members = {
  "image_transport_tutorials::msg",  // message namespace
  "ResizedImage",  // message name
  3,  // number of fields
  sizeof(image_transport_tutorials::msg::ResizedImage),
...
{
  return &::image_transport_tutorials::msg::rosidl_typesupport_introspection_cpp::ResizedImage_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, image_transport_tutorials, msg, ResizedImage)() {
  return &::image_transport_tutorials::msg::rosidl_typesupport_introspection_cpp::ResizedImage_message_type_support_handle;
}
